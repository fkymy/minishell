# Makefile for minishell, updated Sun Jan 24 11:03:34 JST 2021

SRC := command.c main.c parse.c redir.c token.c vector_string.c wordexp.c

OBJ := command.o main.o parse.o redir.o token.o vector_string.o wordexp.o
